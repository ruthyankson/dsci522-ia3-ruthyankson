---
title: "DSCI 522 – IA3 Report"
author: "Ruth Adwowa Yankson"
format:
  html:
    toc: true
    toc-location: left
...
We can see from @fig-horse-all that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-horses-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-all.

:::{#fig-horse-largest width=70%}
